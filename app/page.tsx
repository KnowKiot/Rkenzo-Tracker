...
// Era order + metadata. Replace image with your actual image path e.g. '/images/momentary-bliss.jpg'
const ERAS = [
  {
    name: 'Momentary Bliss',
    image: '/images/Momentary.jpg', // e.g. '/images/momentary-bliss.jpg'
    description: 'Upcoming Album',
  },
  {
    name: 'OS2S: Extended Edition',
    image: '/images/OS2S_Deluxe.webp',
    description: 'Extended edition of One Shot To Shine',
  },
  {
    name: 'OS2S',
    image: '/images/OS2S.png',
    description: 'One Shot To Shine EP era',
  },
  {
    name: 'Young Kenz',
    image: '/images/YK.png',
...
export default function RkenzoTracker() {
  ...
  // Group filtered songs by era, preserving ERAS order
  ...
  const isSearching = search.length > 0 || filterRating !== 'All';
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filters */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-6 flex flex-wrap items-center gap-3 justify-between">
          ...
          {groupedByEra.map((era) => (
            <div key={era.name} className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="flex items-stretch min-h-[120px]">
                {/* Era Image — replace null in ERAS with your image path to show it */}
                <div className="w-40 flex-shrink-0 bg-zinc-800 flex items-center justify-center overflow-hidden">
                  {era.image ? (
                    ...
                    // Placeholder — swap for your image by setting `image` in the ERAS array
